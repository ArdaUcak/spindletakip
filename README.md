...
- **Actions:** Buttons **Yedek Ekle**, **Seçileni Sil**, and **Seçileni Düzenle** arranged on a single row. Add/edit buttons open a modal dialog to capture **Referans ID**, **Açıklama**, **Tamirde mi**, **Bakıma Gönderilme**, and **Geri Dönme**; **Son Güncelleme** auto-fills with the current date at save time (date fields still default to today for convenience).【F:main.py†L191-L218】【F:main.py†L306-L357】
